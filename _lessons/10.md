...
Interestingly, this rune is also how you make the <strong>V</strong> sound. This is because historically
...
Now I know what you're thinking. Just stick with me on this.
...
The ideal way to indicate the V sound is to use what is called a bindrune.
...
And similar to all of the other clusters that are never doubled, this new bindrune would never be doubled either.
...
A bindrune is when you combine two runes together to form a single rune. 
...
If you use the Keyman keyboard with Rune Revival's Runic Keyboard, you will have the "ZWJ" key. You press one rune, then "ZWJ", then the other rune.

Currently there are not many fonts that support bindrunes however, so that is why you won't often see it work. One font that supports them is called Catrinity. On this website, we are using Noto Sans Runic.

...
Why not just use "ᛁᛄ" or "ᛁ"? Well, this "happY" sound could be either of those (or something else all together!), depending on your accent. So this rune represents "whichever sound you make for that". If you wish to instead use "ᛁᛄ" or "ᛁ", you are totally welcome to do that. For the remainder of this course, we will use ᛡ for the happY sound, however.

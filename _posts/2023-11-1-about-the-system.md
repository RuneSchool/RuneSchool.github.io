...
| ᛇ | 4 | The consonant sound for this rune is the same, so the only thing to address is the vowel sound. Basically, the Old English pronunciation of /iːw/ and /e͜oːw/ can easily become /i:o/. There is no immediate need for that exact sound, so we apply it to situations where it would be useful like /iˌoʊ/ and /ɪɒ/. |
...
| ᛡ | 6 | If we say that ᛡ went through [metathesis](https://en.wikipedia.org/wiki/Metathesis_(linguistics)) and became /oj/, we can use this for the CHOICE, PRICE, and FACE lexical sets. This also lets us form diphthongs in unique ways that help to hold many different pronunciations together. |

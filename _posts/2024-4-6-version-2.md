...
Below is what the new system uses now. For more info on FOOT, see below.
...
![possible pronunciations for STRUT](https://ecampusontario.pressbooks.pub/app/uploads/sites/1860/2022/05/STRUT_Lexical_Set_2-300x231.png)
...
ᚢ is just the best compromise between the RP style schwa (ᛟ for us) starting point and the GA style ᚩ.

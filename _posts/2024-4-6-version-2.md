...
Figure out happY rune. This third i sound is used 

* Before vowels: crEate /kriˈeɪt/, and radIo /ˈɹeɪdiˌoʊ/

* End of words: kItty /ˈkɪti/

This means that the happY vowel isn't really a pure /j/ glide, but it really is a full vowel in its own right. In between KIT and FLEECE. If we can make a case that /j/ *is* the happY vowel, then we can use one rune for everything.

We also have ᛄ at our disposal if we want to somehow split the workload up.

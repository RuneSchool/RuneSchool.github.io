...
Option 4 is the best because FOOT and GOOSE are so closely related anyway. ᚢ will remain the cousin that strayed away a bit.

## Misc

Short and highly common words may drop the final glides. For example, "to" may be spelled as just ᛏᚣ instead of ᛏᚣᚹ. Think of how contractions like "gotta", "gonna", "finna", "hafta" sort of end in a FOOT.

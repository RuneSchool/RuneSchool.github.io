...
This rune visually looks like ᛁ inside of ᚢ and would thus be appropriate for any of these sounds between /i/ and /u/.
...
So out of the similar sounds, 12 dialects are using it for the GOOSE phoneme and 11 are using it for the FOOT phoneme. It's almost equal! So here are our options without adding additional data points into that study:
